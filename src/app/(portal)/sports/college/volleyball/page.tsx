export const metadata = { title: "College Volleyball — MLSN" };

export default function CollegeVolleyballPage() {
  return (
    <main className="mx-auto w-full max-w-7xl px-4 py-12 md:px-6 md:py-20 lg:px-10">
      ...
      <p className="mt-4 max-w-prose text-base text-bone-200">
        Section under construction. Scores, rankings, and headlines will live
        here.
      </p>
    </main>
  );
