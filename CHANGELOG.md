...
- _Note: as part of the admin condensation series, the editors above moved under three umbrella sections — AI (personas / opinions / prompts), Memory (canon / lore / library / taxonomy / feeds), and Members (roster / usage / pricing). The original paths 308-redirect to the new locations._
